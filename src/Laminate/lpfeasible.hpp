...
#ifndef LPFEASIBLE_H_
#define LPFEASIBLE_H_
#include <iostream>
#include <Eigen/Dense>
...
public:
    ...
    static const int Size = internal::varsize<isBalanced,isSymmetric>::SIZE;

    typedef typename Miki<Type,isBalanced,ScalarType>::Matrix_t MikiMatrix_t;
	typedef typename Miki<Type,isBalanced,ScalarType>::Vector_t MikiVector_t;
	typedef typename Miki<Type,isBalanced,ScalarType>::Hessian_t MikiHessian_t;
...
private:
	...
	Miki<Type,isBalanced, ScalarType> sublaminate_[NSUBLAM];
...
lampar::internal::cltweight<isSymmetric,NSUBLAM,ScalarType> lampar::lpfeasible<Type,isBalanced,isSymmetric,NSUBLAM,ScalarType> ::clt;
} /* namespace lampar */
